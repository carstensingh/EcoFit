        ...
        <>
            ...
            <div style={{width: '100%', height:'80vh', display:'flex', justifyContent:'center', alignItems:'center', flexDirection:'column'}}>
                <svg
                    ...
                    <div class="grid-item">100 billion items of clothing are produced each year. That equates to roughly 14 items per person.</div>
                    <div class="grid-item">Fast fashion companies produce more pollution than the combined total of international aviation and maritime transport.</div>
                    <div class="grid-item">Every year 92 million tonnes of textile waste is generated by the fashion industry</div>
                    <div class="grid-item">59% of all sustainability claims by European fashion brands are inaccurate</div>
                    <div class="grid-item">The fashion industry consumes around 93 billion cubic metres of water every year</div>
                    <div class="grid-item">These Facts were published by earth.org in 2022</div>
                </div>
